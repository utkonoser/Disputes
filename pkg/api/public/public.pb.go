...
var fileDescriptor_413a91106d7bcce8 = []byte{
	...
	0xc9, 0x4c, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x4f, 0xc9, 0x2c, 0x2e, 0x28, 0x2d,
	0x49, 0x2d, 0xd6, 0x83, 0x08, 0x4b, 0xc9, 0xa4, 0xe7, 0xe7, 0xa7, 0xe7, 0xa4, 0xea, 0x27, 0x16,
	...
	,
}
...
func (c *publicAPIClient) Health(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (*UnimplementedPublicAPIServer) Health(ctx context.Context, req *types.Empty) (*HealthResponse, error) {
...
func _PublicAPI_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublicAPIServer).Health(ctx, req.(*types.Empty))
	}
...
func (m *HealthResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Status) > 0 {
		...
		i = encodeVarintPublic(dAtA, i, uint64(len(m.Status)))
		i--
		dAtA[i] = 0xa
	}
