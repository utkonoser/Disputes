...
func (c *PublicAPI_httpClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
...
var (
	...
	pattern_goclay_PublicAPI_Health_0_builder = func(in *HealthRequest) string {
		values := url.Values{}
