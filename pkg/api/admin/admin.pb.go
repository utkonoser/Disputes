...
func (*HealthRequest) XXX_MessageName() string {
	return "disputes.admin.HealthRequest"
}
...
func (*HealthResponse_Service) XXX_MessageName() string {
	return "disputes.admin.HealthResponse.Service"
}
func init() {
	proto.RegisterType((*HealthRequest)(nil), "disputes.admin.HealthRequest")
	proto.RegisterType((*HealthResponse)(nil), "disputes.admin.HealthResponse")
	proto.RegisterType((*HealthResponse_Service)(nil), "disputes.admin.HealthResponse.Service")
}
...
var fileDescriptor_73a7fc70dcc2027c = []byte{
	...
	,
}
...
func (c *adminAPIClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (*UnimplementedAdminAPIServer) Health(ctx context.Context, req *HealthRequest) (*HealthResponse, error) {
...
func _AdminAPI_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminAPIServer).Health(ctx, req.(*HealthRequest))
	}
